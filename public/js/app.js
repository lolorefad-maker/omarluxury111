...
function createProductCardHTML(prod) {
  const colors = prod.colors || [
    { name: 'Black', hex: '#1c1b1a', image: prod.image },
    { name: 'Tan', hex: '#b5794c', image: prod.image }
  ];
  ...
  return `
    <div class="product-card" id="card-${prod.id}">
      <div class="product-image-box">
        ...
        <img src="${prod.image}" alt="${prod.title}" class="product-image" id="img-${prod.id}">
        
        <div class="quick-actions">
          <button class="action-btn" title="Quick View" onclick="openQuickView('${prod.id}')">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
              <circle cx="12" cy="12" r="3"></circle>
            </svg>
          </button>
          <button class="action-btn" title="Add to Bag" onclick="quickAddToCart('${prod.id}')">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path>
              <line x1="3" y1="6" x2="21" y2="6"></line>
              <path d="M16 10a4 4 0 0 1-8 0"></path>
